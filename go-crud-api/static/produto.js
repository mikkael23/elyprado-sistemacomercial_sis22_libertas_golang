...
function alterar(id) {
    ...
    fetch("http://127.0.0.1:8080/produto/" + id)
    .then(resp => resp.json())
    .then(dados => {
        //preenche os inputs
        const txtdescricao = document.getElementById("txtdescricao");
...
function listar() {
    ...
    fetch("http://127.0.0.1:8080/static/produto.html?pesquisa=" + txtpesquisa.value)
    .then(resp => resp.json())
...
function excluirSim() {
    fetch("http://127.0.0.1:8080/produto/" + idatual,
        {
            headers: {
...
function salvar() {
    ...
    if (idatual<=0) {
        //inserir
        url = "http://127.0.0.1:8080/produto";
        metodo = "POST";
    } else {
        //alterar
        url = "http://127.0.0.1:8080/produto/" + idatual;
        metodo = "PUT";
    }
    fetch(url,
        {
